                ...
                <div className="flex items-center h-screen w-full  font-sans ">
                    <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-lg md:mx-auto">
                        ...
                        <form className="my-8">
                            ...
                            {/* Pre signup request below -> sends email to user to verify credentials */}
                            ...
                            {/* OTP Section starts below */}

                            {/* {
                                disableSignup && <>
                                    <div className="mb-1.5 md:w-full">
                                        <div className="text-sm font-bold text-gray-700 tracking-wide">
                                            OTP
                                        </div>
                                        <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" value={loginDetails.otp} type="text" placeholder="user@gmail.com"
                                            onChange={(e) => setLoginDetails({ ...loginDetails, otp: e.target.value })}
                                        />
                                    </div>
                                    <p className='mb-6 text-xs font-display font-semibold text-indigo-600'>OTP has been send to your Email ID.</p>

                                    <button className="bg-indigo-500 text-gray-100 py-3 px-5 flex items-center bg-blue-500 realtive hover:bg-blue-600 focus:ring text-white uppercase text-sm font-semibold px-4 py-2 rounded"
                                        onClick={(e) => { e.preventDefault(); signupHandler() }}
                                    >Sign Up
                                        <span className={`ml-3 relative top-0.5 ${showSpinner}`}>
                                            <div className="icon-container">
